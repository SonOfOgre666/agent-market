...
export const GOOGLE_REPORT_VIEWS = [
  {
    ...
    description: 'Spend, clicks, and conversions by campaign',
  },
  {
    id: 'account_summary',
    label: 'Account summary',
    api: 'googleAccountSummary',
    description: 'Account totals for the selected period',
  },
  {
    id: 'ad_groups',
    label: 'Ad groups',
    api: 'googleAdGroups',
    description: 'Performance by ad group',
    needsCampaign: true,
  },
  {
    id: 'keywords',
  ...
  },
  {
    ...
    label: 'Ads (RSA)',
    api: 'googleAds',
    description: 'Ad-level performance',
    needsCampaign: true,
  },
  {
    id: 'search_terms',
    ...
    description: 'What people searched',
    needsCampaign: true,
  },
]
